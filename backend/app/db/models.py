...
class OptimizationRun(Base):
    ...
    recommended_meta_label_act_threshold: Mapped[float | None] = mapped_column(Float, nullable=True)
    ...
    current_meta_label_act_threshold: Mapped[float | None] = mapped_column(Float, nullable=True)
